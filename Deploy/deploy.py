...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load(r'C:\Deploy\yolov5-master', 'custom', source ='local', path='last.pt',force_reload=True) ### The repo is stored locally
    ...
    if img_path != None:
        ...
        while True:
            ...
            if cv2.waitKey(5) & 0xFF == 27:
                ...
                cv2.imwrite("final_output.jpg",frame) ## if you want to save the output result.
...
# main(vid_path="test.mp4",vid_out="result_video.mp4") ### for custom video
# main(vid_path=0,vid_out="webcam_result.mp4") #### for webcam

main(img_path="c:\Deploy\caries.jpg") ## for image
